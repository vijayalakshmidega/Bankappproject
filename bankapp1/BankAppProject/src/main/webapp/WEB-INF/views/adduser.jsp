...
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="/adduser" method="post" modelAttribute="adduser">
      <form:form hidden path="uid" value="0"/>
            ...
            <input type="text" id="phone" name="phonenum" placeholder="Enter Mobile Number"/>
